#!/usr/bin/env python3
"""
Recupero codici sconto Norauto da shopilo.it
Sursa: https://shopilo.it/negozi/norauto.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/norauto.it"
STORE_NAME = "Norauto"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Norauto da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-norauto)"
    }
    try:
